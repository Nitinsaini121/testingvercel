...
const AddSubject = ({ setSubmitOpenModal, fetchSubjectList, editData }) => {
  ...
  const onSubmit = async data => {
    ...
    try {
      const response = editData
        ? await TaskSubjectServices.EditSubject(editId, formData)
        : await TaskSubjectServices.AddSubject(formData)

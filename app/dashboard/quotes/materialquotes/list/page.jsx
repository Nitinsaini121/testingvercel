...
const MaterialQuotesList = () => {
  ...
  const handleEditLeads = row => {
    router.push(`/dashboard/quotes/materialquotes/list/edit?id=${row?.original?.id}`)
  }
    ...
    <>
      <div className='mb-3 flex items-center justify-between'>
        ...
        <Button
          ...
          onClick={() => router.push(`/dashboard/quotes/materialquotes/add`)}
        >
          <Plus />
          Add Material Quote
        </Button>
      ...
      <DataTable
        data={user}
        loading={loading}
        columns={MaterialColumn(handleDeleteLeads, handleEditLeads)}

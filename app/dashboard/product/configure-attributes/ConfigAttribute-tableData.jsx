...
const ConfigAttributeTableData = ({
  allConfiAttribute,
  getAllAttributes,
  totalRecord,
  page,
  ...
  const onDelete = async () => {
    if (deleteIndex !== null) {
      ...
      try {
        const response =
          await ConfigureAttributeServices.deleteConfigAttributesById(
            deleteIndex
          )
...
export default ConfigAttributeTableData

...
import { SalePersonSchema } from '../form-validations/user-validation'
...
const AddSalePersonForm = ({ handleCloseDialog,getUsers,editId }) => {
  ...
  const handleSalePersonSubmit = async data => {
    try {
      ...
      // Submit to API
      const response = await UsersServices.AddUser(formData)
      ...
      <FormProvider {...form}>
        ...
        >
          ...
          <div className='mt-4 flex justify-end gap-4'>
            ...
            <Button onClick={() => handleCloseDialog(false)} type='button' className='site-button bg-cyan-400'>
              Cancel
            </Button>
          </div>
        </form>

...
const MaterialList = () => {
  ...
  const handleEditLeads = row => {
    router.push(`/dashboard/quotes/material/list/edit?id=${row?.original?.id}`)
  }
  ...
  return (
    <>
      <div className='mb-3 flex items-center justify-between'>
        <LayoutHeader pageTitle='All Material' />
        <Button
          className='site-button'
          onClick={() => router.push(`/dashboard/quotes/material/add`)}
        >
          <Plus />
          Add Material
        </Button>

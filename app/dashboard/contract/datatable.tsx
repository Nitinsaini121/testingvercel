...
interface DataTableProps<TData extends { id: string }, TValue = unknown> {
  ...
  data: TData[]
  loading: boolean
  handleDeleteContract: (row: { original: TData }) => void
  handleEditContract: (row: { original: TData }) => void
  handleMergeCell: (row: { original: TData }) => void
  totalRecord: number
  page: number
...
export function DataTable<
  TData extends { id: string; refId?: string },
  TValue = unknown
>({
  columns,
  data,
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            ...
                            onClick={() =>
                              router.push(
                                `/dashboard/contract/list/viewpage?id=${row.original.id}`
                              )
                            }
                          >
